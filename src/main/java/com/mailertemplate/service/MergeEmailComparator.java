...
public class MergeEmailComparator implements Comparator<MergeUser>{

	
	public static final MergeEmailComparator INSTANCE =
	        new MergeEmailComparator();

	    private static final Pattern PATTERN = Pattern.compile("(\\D*)(\\d*)");

	    public int compare(MergeUser o1, MergeUser o2) {
...
//	public int compare(MergeUser u1, MergeUser u2) {
